...
const orden = new mongoose.Schema({
    ...
    estado: {type: String, enum: ["pendiente", "pagada", "enviada", "entregada", "cancelada"], required: true, default: "pendiente"}, // 0 pendiente, 1 pagada, 2 enviada, 3 entregada, 4 cancelada
});
